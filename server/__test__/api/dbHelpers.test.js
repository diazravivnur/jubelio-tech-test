...
describe('dbHelpers', () => {
  ...
  describe('insertProducts', () => {
    it('should insert products and log success', async () => {
      const mockProducts = {
        products: [
          { id: 1, title: 'Product 1', price: 100, sku: 'SKU1', thumbnail: 'image1.jpg', description: 'Desc 1' },
          { id: 2, title: 'Product 2', price: 200, sku: 'SKU2', thumbnail: 'image2.jpg', description: 'Desc 2' }
        ]
      };
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['INFO', 'insertProducts', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
    ...
    it('should handle errors when inserting products', async () => {
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['ERROR', 'insertProducts', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
  });
  ...
  describe('getProducts', () => {
    ...
    it('should handle errors when getting products', async () => {
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['ERROR', 'getProducts', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
  });
  ...
  describe('updateProduct', () => {
    it('should update a product and log success', async () => {
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['INFO', 'updateProduct', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
    ...
    it('should handle errors when updating a product', async () => {
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['ERROR', 'updateProduct', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
  });
  ...
  describe('deleteProduct', () => {
    it('should delete a product and log success', async () => {
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['INFO', 'deleteProduct', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
    ...
    it('should handle errors when deleting a product', async () => {
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['ERROR', 'deleteProduct', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
  });
  ...
  describe('getProductDetails', () => {
    it('should return product details', async () => {
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['INFO', 'getProductDetails', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
    ...
    it('should handle errors when getting product details', async () => {
      ...
      expect(CommonHelper.log).toHaveBeenCalledWith(
        ['ERROR', 'getProductDetails', 'dbHelpers.js'],
        expect.any(Object)
      );
    });
  });
